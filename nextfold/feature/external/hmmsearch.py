...
from nextfold.feature import parsers
from nextfold.feature.external import hmmbuild
from nextfold.feature.external import utils
...
class Hmmsearch(object):
    ...
    """
        ...
        if flags is None:
            ...
            flags = [
                '--F1', '0.1', '--F2', '0.1', '--F3', '0.1', '--incE', '100', '-E', '100', '--domE', '100',
                '--incdomE', '100'
            ]
        self.flags = flags
